...
const { message, files, convId, history, settings } = req.body;
 // OLD --- const GEMINI_KEY = process.env.GEMINI_API_KEY;
// SECOND KEY --- const GEMINI_KEY = process.env.GEMINI_KEY;
const GEMINI_KEY = process.env.G1;
console.log("G1:",process.env.G1)
