...
Your task is to select the best model.
...
Rules:
- If coding, debugging, or file edits → qwen-coder
- If deep reasoning or analysis → gemini-3-pro
- If casual chat or simple question → gemini-3-flash
...
`;
  ...
  try {
    ...
    console.error("❌ Router JSON parse failed:", text);
