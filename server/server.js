...
async function handleDocumentGeneration({
  ...
  try {
    ...
    if (document_type === "pdf") {
      ...
      fileBuffer = await buildPDF(finalContent);

      console.log("✅ PDF buffer created");
      console.log("Buffer size:", fileBuffer?.length);

      const rawName = (file_name || "document").replace(/\.pdf$/i, "");
      const safeName = encodeURIComponent((file_name || "document").replace(/\.pdf$/i, ""));
    ...
    if (document_type === "pptx") {
      ...
      const safeName = encodeURIComponent((file_name || "presentation").replace(/\.pptx$/i, ""));
    ...
    if (document_type === "docx") {
      ...
      const safeName = encodeURIComponent((file_name || "document").replace(/\.docx$/i, ""));
