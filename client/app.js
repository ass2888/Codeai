const APP_VERSION = 'v1.281.98'; // يمكنك تحديث هذا يدوياً عند كل تحديث للكاش
...
if (DEBUG_FORCE_REGISTER) {
    ...
    try {
        ...
        // تسجيل المستخدم
        const registerResponse = await fetchWithAuth(`${API_BASE_URL}/api/register`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
                userId: finalUserId,
