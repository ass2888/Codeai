const APP_VERSION = 'v1.281.15'; // يمكنك تحديث هذا يدوياً عند كل تحديث للكاش
...
function updateActiveTab() {
    ...
    const pdfUrl = file.url || '/generated/' + encodeURIComponent(file.name);
editorContainer.innerHTML = `
    <iframe 
        src="https://mozilla.github.io/pdf.js/web/viewer.html?file=${encodeURIComponent(location.origin + pdfUrl)}"
        style="
            width:100%;
            height:100%;
            border:none;
