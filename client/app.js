const APP_VERSION = 'v1.277.5'; // يمكنك تحديث هذا يدوياً عند كل تحديث للكاش
...
const modelLabel = document.createElement('span');
    ...
    modelLabel.style.border = '1px solid rgba(127,127,127,0.2)';
    modelLabel.style.padding = '2px 5px';
    modelLabel.style.borderRadius = '4px';
