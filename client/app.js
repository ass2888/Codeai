const APP_VERSION = 'v1.281.11'; // يمكنك تحديث هذا يدوياً عند كل تحديث للكاش
...
function updateActiveTab() {
    ...
    editorContainer.innerHTML = `
        <iframe 
            src="/generated/${encodeURIComponent(file.name)}"
            style="
                width:100%;
                height:100%;
                border:none;
                ...
                if (parsed.type === 'document' && parsed.document) {
                    ...
                    if (parsed.document) {
                        ...
                        handleIncomingFiles([{
                            ...
                            url: `/generated/${encodeURIComponent(parsed.document.file_name)}`,
                            isBinary: true
                        }]);
                    }
