...
function syncMessagesWithInputBar() {
    const messages = document.getElementById('messages');
    const inputBar = document.querySelector('.input-bar');

    if (!messages || !inputBar) return;

    messages.style.paddingBottom = inputBar.offsetHeight + 20 + 'px';
}
...
// --- Version Display Logic ---
    const APP_VERSION = 'v1.274.7'; // يمكنك تحديث هذا يدوياً عند كل تحديث للكاش
