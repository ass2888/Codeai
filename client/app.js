const APP_VERSION = 'v1.281.23'; // يمكنك تحديث هذا يدوياً عند كل تحديث للكاش
...
if(versionEl) {
    ...
    versionEl.innerHTML = `${APP_VERSION}<br><span style="font-size:9px;opacity:0.6;">${userId}</span>`;
}
